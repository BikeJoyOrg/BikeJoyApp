...
object MascotesAconseguides {
    val mascotesAconseguides = listOf(
        MascotaAconseguidaF(mascotes[0],"a",1,true),
        MascotaAconseguidaF(mascotes[1],"a",1,false),
        MascotaAconseguidaF(mascotes[2],"a",1,false),
        MascotaAconseguidaF(mascotes[3],"a",1,false),
        MascotaAconseguidaF(mascotes[0],"b",0,true),
        MascotaAconseguidaF(mascotes[5],"b",1,false),
        MascotaAconseguidaF(mascotes[2],"b",3,false),
        MascotaAconseguidaF(mascotes[6],"b",2,false),
    )
    ...
    fun getMascotaAconseguida(nombreM: String, nombreU: String): MascotaAconseguidaF {
        for (mascotaAconseguida in mascotesAconseguides) {
            if (mascotaAconseguida.mascota.name == nombreM && mascotaAconseguida.nicknameUsuari == nombreU) {
                return mascotaAconseguida
            }
        }
        return MascotaAconseguidaF(Mascota("Josep1","a", "a", "a","a","a","a","a","a",1.1f, 1.1f, 1.1f),"a",1,true)
    }
}